        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SkillName = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AdministratorProfile_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobPosts_CompanyProfile_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeProfileSkill", x => new { x.EmployeesId, x.SkillsId });
                    table.ForeignKey(
                        name: "FK_EmployeeProfileSkill_Employees_EmployeesId",
                        column: x => x.EmployeesId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeProfileSkill_Skills_SkillsId",
                        column: x => x.SkillsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobSeekerProfileSkill", x => new { x.JobSeekersId, x.SkillsId });
                    table.ForeignKey(
                        name: "FK_JobSeekerProfileSkill_JobSeekers_JobSeekersId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "a581901d-8b2a-4008-bada-d682be8ac633", null, "Administrator", "ADMINISTRATOR" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeProfileSkill_SkillsId",
                table: "EmployeeProfileSkill",
                column: "SkillsId");
